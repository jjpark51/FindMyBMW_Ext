  ...
  return (
    <div>
        ...
        <div className='scroll-body' style={{zIndex: '0' ,height: '100vh' , opacity: '0.4', backgroundAttachment: 'fixed'}}>
            <h1 style={{zIndex: '3', color: 'black' , position: 'relative', left: '40%', top: '40%', width: 'fit-content', cursor: 'default'}}> Finding your BMW...</h1>
                <Box sx={{ width: '30%' , margin: 'auto', position: 'relative', top: '50%'}}>

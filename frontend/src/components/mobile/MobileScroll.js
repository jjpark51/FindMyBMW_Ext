...
import MobileDragCard from './MobileDragCard'
...
function MobileScroll() {
    ...
    const res = QList.slice(1,6).map(e => e);
  return (
    <>
        <QNavigation />
        ...
        <Fade duration={2000}>
            ...
            <div className='page-buttons-wrapper'>
                ...
                <Link to={'/mobileLoading'}><button onClick={handleResult} className='next-button'>Finish</button></Link>
